...
public final class HeavyStormsBlockEntities {
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES = DeferredRegister.create(ForgeRegistries.BLOCK_ENTITY_TYPES, HeavyStorms.MOD_ID);

    public static final RegistryObject<BlockEntityType<LightningCapacitorBlockEntity>> LIGHTNING_CAPACITOR =
