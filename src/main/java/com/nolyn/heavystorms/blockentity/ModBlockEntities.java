...
public final class ModBlockEntities {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<LightningCapacitorBlockEntity>> LIGHTNING_CAPACITOR_BE =
            BLOCK_ENTITIES.register(
                    "lightning_capacitor",
                    () -> BlockEntityType.Builder.of(LightningCapacitorBlockEntity::new, ModBlocks.LIGHTNING_CAPACITOR.get()).build(null)
            );
